...
export default function DashboardPage() {
  ...
  // Menu items with explicit icons (no dynamic lookup)
  ...
  return (
    <div className="flex min-h-screen bg-base-100 overflow-hidden">
      {/* Side Panel – Retractable with spring animation */}
      <motion.div
        initial={false}
      ...
      >
        <div className="p-6">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold text-primary">JobPulse</h2>
            <button 
          ...
          <div className="space-y-1">
            ...
            <button 
              onClick={logout}
              className="flex items-center gap-3 w-full p-4 rounded-lg hover:bg-red-500/20 text-red-400 transition-all duration-200 mt-6"
            >
